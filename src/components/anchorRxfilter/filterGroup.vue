          ...
          <template slot-scope="{ node, data }">
            ...
            <div class="custom-tree-sceond" v-else-if="node.level === 2" @click="setCurrentKey(data.ident)">
              ...
              <div class="btns">
                ...
                <Popover v-if="data.index" placement="bottom-end" :visible-arrow="false" trigger="click">
                  <div class="btnGroup">
...
import relationSet from "@/components/templateFilter/relationSet.vue";
...
export default {
  ...
  computed: {
    ...
    isOnly() {
      ...
      if (chainLists.length === 1 && this.relationList.length === 1) return false;
      return true;
    },
    showPlus() {
      return (ident) => {
  ...
  mounted() {
    // console.log(this.options, this.groupI)
  },
  ...
  methods: {
    ...
    addDevice(ident) {
      ...
      console.log(this.refilterType)
      this.deviceOption = {
        templateId: this.refilterType.options.templateId,
        containerId: this.refilterType.options.containerId,
        anchorCode: this.refilterType.options.anchorCode,
        anchorEquipmentId: this.refilterType.options.anchorEquipmentId,
