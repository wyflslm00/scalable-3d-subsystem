...
<template>
	<div class="cnt">
		<div class="head">
			...
			<div><el-button type="primary" size="small">新增字典</el-button></div>
		</div>
		<div class="table">
			<el-table :data="tableData" border style="width: 100%">
				...
				<el-table-column prop="province" label="字典编号" width="140"> </el-table-column>
				<el-table-column prop="city" label="备注"> </el-table-column>
