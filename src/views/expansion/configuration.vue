...
<template>
	<div class="cnt">
		<div class="head">
			...
			<div><el-button type="primary" size="small">新增配置</el-button></div>
		</div>
		<div class="table">
			<el-table :data="tableData" border style="width: 100%">
				<el-table-column fixed prop="date" label="序号" width="90"> </el-table-column>
				<el-table-column prop="name" label="配置名称" width="260"> </el-table-column>
				<el-table-column prop="province" label="经度" width="140"> </el-table-column>
				<el-table-column prop="city" label="纬度" width="140"> </el-table-column>
